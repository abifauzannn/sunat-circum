        ...
        <div class="max-w-3xl px-4 mx-auto sm:px-6 lg:px-8">
            ...
            <div
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Tambah Komponen</h1>
                        <p class="mt-1 text-gray-600 dark:text-gray-300">Isi form untuk menambahkan komponen baru</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6 bg-white shadow-xl dark:bg-gray-800 rounded-2xl">
                <form action="{{ route('komponens.store') }}" method="POST" class="space-y-6">
                    @csrf

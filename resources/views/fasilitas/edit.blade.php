        ...
        <div class="max-w-4xl px-4 mx-auto sm:px-6 lg:px-8">
            ...
            <div
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Edit Fasilitas</h1>
                        <p class="mt-1 text-gray-600 dark:text-gray-300">Perbarui informasi fasilitas klinik Anda</p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="relative">
                                <div class="flex items-center justify-center p-4 bg-gray-50 dark:bg-gray-700 rounded-xl">
                                    <img id="previewImage"
                                        src="{{ $fasilitas->image ? asset('storage/' . $fasilitas->image) : 'https://via.placeholder.com/200x120?text=Preview+Image' }}"
                                        alt="Preview Image"

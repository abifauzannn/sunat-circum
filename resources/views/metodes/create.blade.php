        ...
        <div class="max-w-3xl px-4 mx-auto sm:px-6 lg:px-8">
            ...
            <div
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Tambah Metode</h1>
                        <p class="mt-1 text-gray-600 dark:text-gray-300">Isi form untuk menambahkan metode baru</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6 bg-white shadow-xl dark:bg-gray-800 rounded-2xl">
                <form action="{{ route('metodes.store') }}" method="POST" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="4"
                            class="block w-full px-4 py-2 text-gray-900 border-gray-300 rounded-xl shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white sm:text-sm">{{ old('deskripsi') }}</textarea>
                    </div>

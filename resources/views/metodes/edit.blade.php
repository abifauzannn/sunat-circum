        ...
        <div class="max-w-4xl px-4 mx-auto sm:px-6 lg:px-8">
            ...
            <div
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Edit Metode</h1>
            ...
            <div class="mb-8 overflow-hidden bg-white shadow-xl dark:bg-gray-800 rounded-2xl">
                <form action="{{ route('metodes.update', $metode->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="p-6 space-y-8 sm:p-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="relative">
                                ...
                                <div
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-gray-300">
                                        <span class="font-medium text-blue-600 hover:text-blue-500">Klik untuk ganti
                                            gambar</span>
                                        atau drag & drop
                                    </p>
                            ...
                            <div class="relative">
                                <div class="flex items-center justify-center p-4 bg-gray-50 dark:bg-gray-700 rounded-xl">
                                    <img id="previewImage"
                                        src="{{ $metode->image ? asset('storage/' . $metode->image) : 'https://via.placeholder.com/200x120?text=Preview+Image' }}"
                                        alt="Preview Image"
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="name" value="{{ old('name', $metode->name) }}"
                                ...
                                placeholder="Masukkan nama metode..." required>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea name="description" rows="4"
                                class="w-full px-4 py-3 transition-all duration-200 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                                placeholder="Masukkan deskripsi metode...">{{ old('description', $metode->description) }}</textarea>
                        </div>
                    </div>

        ...
        <div class="max-w-4xl px-4 mx-auto sm:px-6 lg:px-8">
            ...
            <div
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Tambah Paket</h1>
                        <p class="mt-1 text-gray-600 dark:text-gray-300">Masukkan data paket baru untuk klinik Anda</p>
                    </div>
                </div>
            </div>

    ...
    <div class="min-h-screen py-8 bg-gray-100 dark:bg-gray-900">
        <div class="max-w-4xl px-4 mx-auto sm:px-6 lg:px-8">
            ...
            <div
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-gray-600 dark:text-gray-300">Ubah informasi Layanan sesuai kebutuhan</p>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-8 overflow-hidden bg-white shadow-xl dark:bg-gray-800 rounded-2xl">
                <form action="{{ route('layanans.update', $service->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="p-6 space-y-8 sm:p-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="relative">
                                <div class="flex items-center justify-center p-4 bg-gray-50 dark:bg-gray-700 rounded-xl">
                                    <img id="previewImage"
                                        src="{{ $service->image ? asset('storage/' . $service->image) : 'https://via.placeholder.com/200x120?text=Preview+Image' }}"
                                        alt="Preview Image"
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea name="description" rows="4"
                                class="w-full px-4 py-3 transition-all duration-200 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                                placeholder="Tuliskan deskripsi layanan..." required>{{ old('description', $service->description) }}</textarea>
                        </div>
                    </div>
    ...
    <script>
        document.getElementById('imageInput').addEventListener('change', function(event) {
            ...
            if (file) {
                ...
                preview.src =
                    '{{ $service->image ? asset('storage/' . $service->image) : 'https://via.placeholder.com/200x120?text=Preview+Image' }}';
            }
        });
    </script>
@endsection

    ...
    <div class="min-h-screen py-8 bg-gray-100 dark:bg-gray-900">
        <div class="max-w-6xl px-4 mx-auto sm:px-6 lg:px-8">
            ...
            <div
                ...
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Daftar Layanan</h1>
                <p class="mt-1 text-gray-600 dark:text-gray-300">Kelola layanan yang tersedia</p>
            </div>
            ...
            <div class="overflow-hidden bg-white shadow-xl dark:bg-gray-800 rounded-2xl">
                <div class="flex items-center justify-between px-6 py-4 border-b dark:border-gray-700">
                    <h2 class="text-lg font-semibold text-gray-800 dark:text-white">Tabel Layanan</h2>
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            @forelse ($services as $service)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                    ...
                                    <td class="px-6 py-4 text-sm">{{ $service->description }}</td>
                                    <td class="px-6 py-4 text-center">
                                        <div class="flex items-center justify-center space-x-2">
                                            <a href="{{ route('layanans.edit', $service->id) }}"
                                                class="px-3 py-1 text-sm text-white bg-blue-600 rounded-lg hover:bg-blue-700">Edit</a>
                                            <form action="{{ route('layanans.destroy', $service->id) }}" method="POST"
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="px-6 py-4 text-center text-gray-500">Belum ada layanan.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>

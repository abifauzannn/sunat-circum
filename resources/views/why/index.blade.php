        ...
        <div class="max-w-6xl px-4 mx-auto sm:px-6 lg:px-8">
            ...
            <div
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Daftar Why</h1>
                        <p class="mt-1 text-gray-600 dark:text-gray-300">Kelola daftar why yang tersedia</p>
                    </div>
                </div>
            </div>
            ...
            <div class="overflow-hidden bg-white shadow-xl dark:bg-gray-800 rounded-2xl">
                <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    <h2 class="text-lg font-semibold text-gray-800 dark:text-white">Tabel Why</h2>
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            @forelse ($why as $item)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-800 dark:text-gray-200">{{ $item->name }}</td>
                                    <td class="px-6 py-4 text-sm text-center">
                                        <div class="flex items-center justify-center space-x-2">
                                            <a href="{{ route('why.edit', $item->id) }}"

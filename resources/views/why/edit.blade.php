        ...
        <div class="max-w-3xl px-4 mx-auto sm:px-6 lg:px-8">
            ...
            <div
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Why</h1>
                        <p class="mt-1 text-gray-600 dark:text-gray-300">Ubah informasi Why sesuai kebutuhan</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6 bg-white shadow-xl dark:bg-gray-800 rounded-2xl">
                <form action="{{ route('why.update', $why->id) }}" method="POST" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        <label for="name" class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-200">Nama
                            Why</label>
                        <input type="text" id="name" name="name" value="{{ old('nama', $why->name) }}"

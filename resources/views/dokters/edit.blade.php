        ...
        <div class="max-w-4xl px-4 mx-auto sm:px-6 lg:px-8">
            ...
            <div
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Edit Dokter</h1>
                        <p class="mt-1 text-gray-600 dark:text-gray-300">Perbarui informasi Dokter klinik Anda</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="p-6 space-y-8 sm:p-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="relative">
                                <div class="flex items-center justify-center p-4 bg-gray-50 dark:bg-gray-700 rounded-xl">
                                    <img id="previewImage"
                                        src="{{ $dokter->image ? asset('storage/' . $dokter->image) : 'https://via.placeholder.com/200x120?text=Preview+Image' }}"
                                        alt="Preview Image"
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="sip" value="{{ old('sip', $dokter->sip) }}"
                                class="w-full px-4 py-3 transition-all duration-200 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                                placeholder="Masukkan Sip..." required>
                        </div>
                    </div>

        ...
        <div class="max-w-3xl px-4 mx-auto sm:px-6 lg:px-8">
            ...
            <div
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Tambah Kelas</h1>
                        <p class="mt-1 text-gray-600 dark:text-gray-300">Isi form untuk menambahkan kelas baru</p>
                    </div>
                </div>
            </div>

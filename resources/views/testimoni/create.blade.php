        ...
        <div class="max-w-4xl px-4 mx-auto sm:px-6 lg:px-8">
            ...
            <div
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Tambah Testimoni</h1>
                        <p class="mt-1 text-gray-600 dark:text-gray-300">Masukkan testimoni baru dari pengguna</p>
                    </div>
                </div>
            </div>
                        ...
                        <div id="uploadWrapper" class="space-y-4">
                            ...
                            <div class="relative">
                                <input type="file" name="media" id="mediaInput" accept="image/*,video/*"
                                    class="absolute inset-0 z-10 w-full h-full opacity-0 cursor-pointer" required>
                                <div

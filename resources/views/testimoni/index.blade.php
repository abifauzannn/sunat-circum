    ...
    <div class="min-h-screen py-8 bg-gray-100 dark:bg-gray-900">
        <div class="max-w-6xl px-4 mx-auto sm:px-6 lg:px-8">
            ...
            <div
                ...
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Daftar Testimoni</h1>
                <p class="mt-1 text-gray-600 dark:text-gray-300">Kelola testimoni dari pengguna</p>
            </div>
            ...
            <div class="overflow-hidden bg-white shadow-xl dark:bg-gray-800 rounded-2xl">
                <div class="flex items-center justify-between px-6 py-4 border-b dark:border-gray-700">
                    <h2 class="text-lg font-semibold text-gray-800 dark:text-white">Tabel Testimoni</h2>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-gray-700">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-sm font-medium text-center text-gray-700 dark:text-gray-300">
                                    Aksi
                                </th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="px-6 py-4 text-center text-gray-500">Belum ada testimoni.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>

        ...
        <div class="max-w-3xl px-4 mx-auto sm:px-6 lg:px-8">
            ...
            <div
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Tambah Lokasi</h1>
                        <p class="mt-1 text-gray-600 dark:text-gray-300">Isi form untuk menambahkan lokasi cabang baru</p>
                    </div>
                </div>
            </div>
                ...
                <form action="{{ route('lokasi.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="nama_cabang" name="nama_cabang" value="{{ old('nama_cabang') }}"
                            class="block w-full px-4 py-2 text-gray-900 border-gray-300 shadow-sm rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:text-white sm:text-sm"
                            required>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="alamat_cabang" name="alamat_cabang" rows="3"
                            class="block w-full px-4 py-2 text-gray-900 border-gray-300 shadow-sm rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:text-white sm:text-sm"
                            required>{{ old('alamat_cabang') }}</textarea>
                    </div>

...
@section('content')
        ...
        <div class="max-w-4xl px-4 mx-auto sm:px-6 lg:px-8">
            ...
            <div
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Edit Review</h1>
                        <p class="mt-1 text-gray-600 dark:text-gray-300">Ubah informasi Review sesuai kebutuhan</p>
                    </div>
                </div>
            </div>
                ...
                <form action="{{ route('reviews.update', $review->id) }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="p-6 space-y-8 sm:p-8">
                        ...
                        <div class="space-y-4">
                            <label class="flex items-center text-sm font-semibold text-gray-900 dark:text-white">
                                <svg class="w-4 h-4 text-yellow-600 me-2" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-gray-300">
                                        <span class="font-medium text-yellow-600 hover:text-yellow-500">Klik untuk
                                            upload</span>
                                        atau drag & drop untuk mengganti icon
                                    </p>
                            ...
                            <div class="relative">
                                <div class="flex items-center justify-center p-4 bg-gray-50 dark:bg-gray-700 rounded-xl">
                                    <img id="previewIcon"
                                        src="{{ $review->icon ? asset('storage/' . $review->icon) : 'https://via.placeholder.com/200x120?text=Preview+Icon' }}"
                                        alt="Preview Icon"
                                ...
                                <div id="iconInfo"
                                    ...
                                    <span id="iconFileName"></span> - <span id="iconFileSize"></span>
                                </div>
                            </div>
                            @error('icon')
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="number" name="review_count"
                                ...
                                class="w-full px-4 py-3 transition-all duration-200 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-yellow-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                                placeholder="Masukkan jumlah review..." min="0" required>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex flex-col gap-4 sm:flex-row sm:justify-end">
                            ...
                            <button type="submit"
                                class="w-full px-8 py-3 font-medium text-white transition-all duration-200 transform shadow-lg sm:w-auto bg-gradient-to-r from-blue-600 to-indigo-600 rounded-xl hover:from-blue-700 hover:to-indigo-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 hover:shadow-xl hover:scale-105">
                                Update Review
                            </button>
                        </div>
                    </div>
    ...
    <script>
        document.getElementById('iconInput').addEventListener('change', function(event) {
            ...
            const fileSize = document.getElementById('iconFileSize');
            const info = document.getElementById('iconInfo');
            ...
            if (file) {
                ...
                preview.src =
                    '{{ $review->icon ? asset('storage/' . $review->icon) : 'https://via.placeholder.com/200x120?text=Preview+Icon' }}';

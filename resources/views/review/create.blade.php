    ...
    <div class="min-h-screen py-8 bg-gray-100 dark:bg-gray-900">
        <div class="max-w-4xl px-4 mx-auto sm:px-6 lg:px-8">
                    ...
                    <div
                        ...
                        <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 11c0-1.104.896-2 2-2h4a2 2 0 012 2v6a2 2 0 01-2 2h-4c-1.104 0-2-.896-2-2v-6zM6 11c0-1.104.896-2 2-2h2v10H8a2 2 0 01-2-2v-6z" />
                        </svg>
                    </div>
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Tambah Review</h1>
                        <p class="mt-1 text-gray-600 dark:text-gray-300">Masukkan data review baru untuk klinik Anda</p>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-8 overflow-hidden bg-white shadow-xl dark:bg-gray-800 rounded-2xl">
                <form action="{{ route('reviews.store') }}" method="POST" enctype="multipart/form-data" class="space-y-0">
                    @csrf
                    ...
                    <div class="p-6 space-y-8 sm:p-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="relative">
                                <div class="flex items-center justify-center p-4 bg-gray-50 dark:bg-gray-700 rounded-xl">
                                    <img id="previewIcon" src="https://via.placeholder.com/200x120?text=Preview+Icon"
                                        alt="Preview Icon"
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="number" name="review_count" value="{{ old('review_count') }}"
                                class="w-full px-4 py-3 transition-all duration-200 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
    ...
    <script>
        document.getElementById('iconInput').addEventListener('change', function(event) {
            ...
            if (file) {
                ...
                preview.src = 'https://via.placeholder.com/200x120?text=Preview+Icon';

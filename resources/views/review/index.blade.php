        ...
        <div class="max-w-6xl px-4 mx-auto sm:px-6 lg:px-8">
            ...
            <div
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Daftar Review</h1>
                        <p class="mt-1 text-gray-600 dark:text-gray-300">Kelola review dari pengguna</p>
                    </div>
                </div>
            </div>
            ...
            <div class="overflow-hidden bg-white shadow-xl dark:bg-gray-800 rounded-2xl">
                <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    <h2 class="text-lg font-semibold text-gray-800 dark:text-white">Tabel Review</h2>
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            @forelse ($reviews as $review)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        @if ($review->icon)
                                            <img src="{{ asset('storage/' . $review->icon) }}" alt="icon"
                                                class="object-cover w-10 h-10 rounded-full">
                                        @else
                                            <span class="text-sm italic text-gray-400">Tidak ada</span>
                                        @endif
                                    </td>
                                    <td class="px-6 py-4 text-sm text-gray-800 dark:text-gray-200">{{ $review->name }}</td>
                                    <td class="px-6 py-4 text-sm text-gray-800 dark:text-gray-200">
                                        {{ $review->review_count }}</td>
